...
urlpatterns = [
    ...
    path('messages/upload/', message_views.message_upload, name='message_upload'),
    path('messages/attachment/<int:attachment_id>/', message_views.message_attachment, name='message_attachment'),
    ...
    path('task/upload/', views.task_upload, name='task_upload'),
    path('task/attachment/<int:attachment_id>/', views.task_attachment, name='task_attachment'),
    path('task/attachment/<int:attachment_id>/delete/', views.task_attachment_delete, name='task_attachment_delete'),
